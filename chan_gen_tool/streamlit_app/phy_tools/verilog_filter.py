...
from vgen_xilinx import gen_dsp48E1, gen_dsp48E2
from adv_pfb import gen_pfb
from verilog_gen import gen_ram, gen_axi_fifo, gen_slicer, name_help, gen_rom, ret_addr_width, axi_fifo_inst
from gen_utils import ret_module_name, ret_valid_path, print_header
from fp_utils import ret_num_bitsU
...
def gen_cic_top(path, cic_obj, count_val=1024, qvec_correction=None, prefix='', slice_shift=0,
    ...
    downsamp_name = None
    if cic_obj.r_max > 1:
        downsamp_name = verilog_gen.gen_axi_downsample(path)
        print(downsamp_name)
